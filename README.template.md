...
<a href="https://github.com/spencer/wfp-website/generate">
...
Prepare your repository for use by removing wfp-website branding and replacing it with your own project name and description.
...
<details>
<summary>2. Run the "Remove wfp-website branding" action</summary>

1. Click the "Actions" tab in the top navigation of your repository
2. Click the "Remove wfp-website branding" workflow
...
Start your project with wfp-website by clicking the "Use this template" button below:
...
Deploy your wfp-website site for **free** with GitHub Pages:
...
Deploy wfp-website to [Netlify](https://netlify.com) for **free**!
...
Deploy wfp-website to [Cloudflare Pages](https://pages.cloudflare.com/) for global edge performance:
...
wfp-website includes additional features that are disabled by default. Enable them when you need them:
...
* Reusable components via [eleventy-plugin-reusable-components](https://github.com/spencer/eleventy-plugin-reusable-components)
...
```text
example.com                 # → Root of your wfp-website project
...
├── README.wfp-website.md     # → Template documentation
