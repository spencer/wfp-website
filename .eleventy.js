...
// Local imports
import build from "./src/assets/config/build.js";
...
const tasks = [
  { icon: "📚", name: "Collections", path: "./src/assets/config/collections.js" },
  { icon: "🔌", name: "Plugins", path: "./src/assets/config/plugins.js" },
  { icon: "⏩", name: "Shortcodes", path: "./src/assets/config/shortcodes.js" },
  { icon: "🔍", name: "Filters ", path: "./src/assets/config/filters.js" },
  { icon: "🔀", name: "Transforms", path: "./src/assets/config/transforms.js" },
  { icon: "🚚", name: "Passthroughs", path: "./src/assets/config/passthroughs.js" },
  {
    icon: "📜",
    name: "Template Languages",
    path: "./src/assets/config/templateLanguages.js",
  },
  { icon: "👀", name: "Watch Targets", path: "./src/assets/config/watchtargets.js" },
];
